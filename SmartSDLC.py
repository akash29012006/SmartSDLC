...
Original file is located at
    https://colab.research.google.com/drive/1tzjWbjSzNJ8iOAmNnjtgnLsbhE-siXZq
"""
...
def requirement_analysis(pdf_file, prompt_text):
    ...
    if pdf_file is not None:
        ...
        analysis_prompt = f"Analyze the following document and extract key software requirements. Organize them into functional requirements, non-functional requirements, and technical requirements:\n\n{content}\n\nAnalysis:"
    else:
        analysis_prompt = f"Analyze the following requirements and organize them into functional requirements, non-functional requirements, and technical requirements:\n\n{prompt_text}\n\nAnalysis:"
